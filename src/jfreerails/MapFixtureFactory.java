...
public class MapFixtureFactory {
	...
	public static void generateTrackRuleList(World world) {
		...
		trackRuleProperties[0] = new TrackRuleProperties(1, false, "type0", 0, false, 0);
		...
		trackRuleProperties[1] = new TrackRuleProperties(2, false, "type1", 1, false, 0);
		...
		//3rd track type..
		trackRuleProperties[2] = new TrackRuleProperties(3, false, "type2", 2, false, 0);
