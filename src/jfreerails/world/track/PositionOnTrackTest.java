...
public class PositionOnTrackTest extends TestCase {
	...
	public void testValidation() {
		...
		assertException(
			PositionOnTrack.MAX_COORINATE + 1,
			PositionOnTrack.MAX_COORINATE,
			OneTileMoveVector.NORTH_WEST);
	...
	public void testToInt() {
		PositionOnTrack p1 =
			new PositionOnTrack(10, 20, OneTileMoveVector.NORTH);
		PositionOnTrack p2 =
			new PositionOnTrack(10, 30, OneTileMoveVector.NORTH);
	...
	public void testSetValuesFromInt() {
		...
		int i = p1.toInt();
		PositionOnTrack p2 =
			new PositionOnTrack(60, 70, OneTileMoveVector.EAST);
