...
package jfreerails.world.station.naming;
...
public class VerifyStationName {
	...
	public String getName() {
		...
		if (w.size(KEY.STATIONS) <= 0) {
			...
			return appropriateName + " Station";
		}
				
		found = checkStationExists(appropriateName + " Station");
		if (!found) {
			appropriateName = appropriateName + " Station";
