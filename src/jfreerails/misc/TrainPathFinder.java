...
public class TrainPathFinder implements IntIterator, FreerailsSerializable {
	...
	*/
	...
	public int nextInt(){
		TrackTileMap map = trackExplorer.getMap();
		PositionOnTrack[] t = NewFlatTrackExplorer.getPossiblePositions(map, new Point(targetX, targetY));
		...
		NewFlatTrackExplorer tempExplorer = new NewFlatTrackExplorer(trackExplorer.getMap(), tempP);
