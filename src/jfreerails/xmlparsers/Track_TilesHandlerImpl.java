...
public class Track_TilesHandlerImpl implements Track_TilesHandler, TrackSetFactory {
	...
	protected jfreerails.world.type.TrackRuleProperties trackRuleProperties;
	protected jfreerails.world.flat.LegalTrackConfigurations legalTrackConfigurations;
	public static final boolean DEBUG = false;
	protected jfreerails.world.TrackRuleList trackRuleList;
	...
	public void end_ListOfTrackPieceTemplates() throws SAXException {
		legalTrackConfigurations =
			new jfreerails.world.flat.LegalTrackConfigurations(maxConsequ, legalTemplates);
		legalTemplates = null;
	}
	...
	public void start_TrackType(final Attributes meta) throws SAXException {
		...
		trackRuleProperties =
			new jfreerails.world.type.TrackRuleProperties(
				rGBvalue,
				enableDoubleTrack,
				typeName,
				ruleNumber);
	...
	public void end_TrackType() throws SAXException {
		...
		ruleList.add(
			(Object) (new jfreerails.world.type
	...
	public void end_TrackSet() throws SAXException {
		trackRuleList = new jfreerails.world.TrackRuleList(ruleList);
	...
	public jfreerails.world.TrackRuleList getTrackRuleList() {
