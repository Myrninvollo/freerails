...
final public class BackgroundMapView implements MapViewLayer {
	...
	final public class TrackLayer implements MapViewLayer {
	...
	final public class TerrainLayer implements MapViewLayer {
