...
public class ZoomedOutMapView implements NewMapView, MoveReceiver {
	...
	public ZoomedOutMapView(FreerailsMap map) {
		this.terrainMap = map.getTerrainMap();
		this.trackSystem = map.getTrackMap();
		this.refresh();
	...
	public void refreshTile(Point tile) {
		...
		if (node != null) {
			...
			rgb = terrainMap.getTerrainTileType(tile.x, tile.y);
		}
