 ...
 *@version    1.0
 * N.B. Based on code from javagaming.org Scroller by Jeff Kesselman.
 */

public abstract class BufferedTiledBackgroundPainter implements NewMapView {
    ...
    public void paintRect(java.awt.Graphics outputGraphics, Rectangle newVisibleRectectangle) {
    ...
    /**
     *  Changes the size of the backbuffer
     *
    ...
    public abstract void refreshTile(Point tile);
