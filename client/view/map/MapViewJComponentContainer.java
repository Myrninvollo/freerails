 ...
 * @author Luke Lindsay
 */
public class MapViewJComponentContainer
	...
	private MapViewJComponentContainer(MapViewJComponent mv) {
		...
		((JComponent)mapView).addMouseListener(myMouseInputAdapter);
		((JComponent)mapView).addMouseMotionListener(myMouseInputAdapter);
