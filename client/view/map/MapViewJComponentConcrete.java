...
public class MapViewJComponentConcrete
	...
	private class MapViewJComponentMouseAdapter
		...
		public void mousePressed(java.awt.event.MouseEvent mouseEvent) {
			if (SwingUtilities.isLeftMouseButton(mouseEvent)) {
				...
				cursor.TryMoveCursor(
					new java.awt.Point(x / tileSize.width, y / tileSize.height));
	...
	public MapViewJComponentConcrete(
		...
		this.cursor = new FreerailsCursor(mapView);
	...
	public void cursorJumped(CursorEvent ce) {
		...
		for (tile.x = ce.newPosition.x - 1; tile.x < ce.newPosition.x + 2; tile.x++) {
			for (tile.y = ce.newPosition.y - 1; tile.y < ce.newPosition.y + 2; tile.y++) {
