...
public class BackgroundMapView implements NewMapView {
    ...
    public class TrackLayer implements NewMapView {
    ...
    public class TerrainLayer implements NewMapView {
    ...
    public BackgroundMapView(jfreerails.map.FreerailsMap map, TileViewList tiles, TrackPieceViewList trackPieceViewList) {
        trackLayer = new TrackLayer(map.getTrackMap(), trackPieceViewList);
        terrainLayer = new TerrainLayer(map.getTerrainMap(), tiles);
