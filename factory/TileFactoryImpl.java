...
public class TileFactoryImpl extends java.lang.Object implements TileFactory {
    ...
    private class ParsingVariables extends java.lang.Object {
        ...
        *  Description of the Field
        */
        public TileType parentTileModel;
    ...
    */
    ...
    public TileFactoryImpl( URL xml_url ) throws FreerailsException {
    ...
    */
    ...
    public TileFactoryImpl( URL xml_url, ImageSplitter terrain ) throws FreerailsException {
        this( xml_url );
        if( terrain != null ) {
    ...
    private void processList( NodeList tilesToProcess, ParsingVariables parsingVariables ) throws FreerailsException {
        for( int  i = 0;i < tilesToProcess.getLength();i++ ) {
            ...
            if( str.equalsIgnoreCase( "Tile" ) ) {
                TileType  tileModel = getTileModel( (Element)tile );
    ...
    */
    ...
    /**
    *  Gets the tileView attribute of the TileFactoryImpl object
    *
    *@param  tile                    Description of Parameter
    *@param  imageSplitter           Description of Parameter
    *@param  tileModel               Description of Parameter
    *@param  parentTileView          Description of Parameter
    *@return                         The tileView value
    *@exception  FreerailsException  Description of Exception
    */
    
    private TileView getTileView( Element tile, ImageSplitter imageSplitter, TileType tileModel, TileView parentTileView ) throws FreerailsException {
        TileView  tileView;
        int  x;
        int  y;
    ...
    */
    ...
    private int[] getRGBValuesToCheckFor( TileType tileModel, Element tile ) {
