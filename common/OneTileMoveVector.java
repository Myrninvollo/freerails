...
public class OneTileMoveVector extends java.lang.Object {
    ...
    */
    ...
    public OneTileMoveVector( int x, int y ) throws jfreerails.common.exception.FreerailsException {
        if( ( ( ( x < -1 ) || ( x > 1 ) ) || ( ( y < -1 ) || ( y > 1 ) ) ) || ( ( x == 0 ) && ( y == 0 ) ) ) {
            throw new jfreerails.common.exception.FreerailsException( "The values passed both must be integers in the range -1 to 1, and not both equal 0." );
        }
        else {
            deltaX = x;
            deltaY = y;
