...
public class EightRotationsOfTrackPieceProducer extends java.lang.Object {
    ...
    public static int [] getRotations (int trackBlueprint){
     ...
     private static boolean[][] rotateTrackNodeClockwise(boolean[][] source){
       ...
       grabValueFrom[0]  =new IntPoint[] {new IntPoint(0,1),new IntPoint(0,0),new IntPoint(1,0)};
       grabValueFrom[1]  =new IntPoint[] {new IntPoint(0,2),new IntPoint(1,1),new IntPoint(2,0)};             
       grabValueFrom[2]  =new IntPoint[] {new IntPoint(1,2),new IntPoint(2,2),new IntPoint(2,1)};
